                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-x-6 gap-y-2">
                          <div className="md:row-start-1 md:col-start-1">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-gray-400 text-sm" style={{ fontFamily: "'Public Sans ', Sans-serif" }}>
                                {tanggal}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="md:row-start-1 md:col-start-2">
                            <div className="flex items-center gap-2">
                              ...
                              <p className="text-black text-xs" style={{ fontFamily: "'Public Sans', Sans-serif", fontWeight: 500 }}>
                                {tipe}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="md:row-start-2 md:col-start-1">
                            ...
                            >
                              <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "'Public Sans', sans-serif" }}>SKOR KEYAKINAN</p>
